# Transfer manifest â€” Ã¢â€ â€™ ext/chimera_core/target/release/libchimera_core.so (or .dylib / .dll)

## Schedule A â€” Included (typical)

1. Git repository `theworker02/ruby_llm_mesh` (or content transfer)
2. Original Product source/docs as of closing tag
3. `docs/acquisition/` diligence materials
4. In-repo marks created for Ã¢â€ â€™ ext/chimera_core/target/release/libchimera_core.so (or .dylib / .dll)
